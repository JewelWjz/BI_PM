...
完整资料来源清单详见：[`references/BI_RESOURCES.md`](./references/BI_RESOURCES.md)

### 资料优先级速查

| 优先级              | 用途                                 | 读取方式              |
| ------------------- | ------------------------------------ | --------------------- |
| **P0** CSV          | 功能数量权威来源（精确数字以此为准） | 全量读取              |
| **P1** 白皮书精华版 | 产品定位/架构/核心功能概览（49页）   | `pages: "1-20"` 起步  |
| **P2** 官网手册链接 | 功能模块官方文档入口索引             | 读取后按需点开链接    |
| **P3** 白皮书内部版 | 深度技术细节与内部设计逻辑（266页）  | 按需指定 `pages` 范围 |
